$url = "https://brdecledtyypykowjnjt.supabase.co/rest/v1/production_plan?or=(firm_plan.ilike.*2026-06-16*,no_order.ilike.*2026-06-16*)&limit=5"
$headers = @{
...
if ($res) {
  Write-Output "Found $($res.Count) plans:"
  $res | ConvertTo-Json
} else {
  Write-Output "No plans matching '2026-06-16' found."
}
