...
$uri = "$SUPABASE_URL/rest/v1/foaming_separate_reports?report_date=eq.2026-06-04&select=id,firm_plan,actual_sheet_received,sheet_thickness_mm,actual_bun_separated,created_at,report_date"
