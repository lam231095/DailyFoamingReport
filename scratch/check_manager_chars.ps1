$url = "https://brdecledtyypykowjnjt.supabase.co/rest/v1/foaming_separate_reports?id=eq.9ea8816b-6b70-481c-8bd2-f9a6d5d72022&select=manager_name"
$headers = @{
