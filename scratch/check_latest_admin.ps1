$url = "https://brdecledtyypykowjnjt.supabase.co/rest/v1/foaming_pour_reports?recorder_id=eq.8acc93be-cff0-4103-b76f-4de025e9bca1&order=created_at.desc&limit=5"
$headers = @{
...
if ($res) {
  ...
  Write-Output "No recent reports found for admin."
}
