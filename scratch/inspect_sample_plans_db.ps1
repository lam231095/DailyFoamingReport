...
$url = "https://brdecledtyypykowjnjt.supabase.co/rest/v1/production_plan?week_label=eq.Sample&select=firm_plan,sl_bun_can_do,sl_bun_can_tach,no_order&limit=20"
$records = Invoke-RestMethod -Uri $url -Headers $headers -Method Get
$records | Format-Table -AutoSize | Out-String -Width 300
