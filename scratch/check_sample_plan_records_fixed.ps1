...
$uri = "$SUPABASE_URL/rest/v1/production_plan?week_label=eq.Sample&select=firm_plan,ten_san_pham,sl_sheet,sl_bun_can_tach"
$plans = Invoke-RestMethod -Uri $uri -Headers $headers -Method Get
Write-Host "Sample plans currently in DB:"
