$url = "https://brdecledtyypykowjnjt.supabase.co/rest/v1/foaming_pour_reports?report_date=gte.2026-06-08&order=created_at.desc"
$headers = @{
...
if ($res) {
  Write-Output "Found $($res.Count) reports on or after June 8."
  $res | ConvertTo-Json
} else {
  Write-Output "No reports found on or after June 8."
}
