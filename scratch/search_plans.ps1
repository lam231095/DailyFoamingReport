$url = "https://brdecledtyypykowjnjt.supabase.co/rest/v1/production_plan?or=(pu_code.eq.PVN-003581,bun_code.eq.BDB-000234)&select=*"
$headers = @{
...
if ($res) {
  Write-Host "Found plans:"
  $res | ConvertTo-Json
} else {
  Write-Host "NO PLANS found for pu_code/bun_code"
}
