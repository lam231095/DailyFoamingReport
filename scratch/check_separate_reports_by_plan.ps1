...
$uri = "$SUPABASE_URL/rest/v1/foaming_separate_reports?firm_plan=like.*260604*&select=id,firm_plan,actual_sheet_received,sheet_thickness_mm,actual_bun_separated,report_date"
$reports = Invoke-RestMethod -Uri $uri -Headers $headers -Method Get

Write-Host "Reports in foaming_separate_reports matching *260604*:"
