$url = "https://brdecledtyypykowjnjt.supabase.co/rest/v1/foaming_pour_reports?firm_plan=eq.FPRO-260428-0014&report_date=eq.2026-06-10"
$headers = @{
...
if ($res) {
  Write-Output "Found $($res.Count) pour reports for FPRO-260428-0014 on 2026-06-10:"
  $res | ConvertTo-Json
} else {
  Write-Output "No pour reports found."
}
