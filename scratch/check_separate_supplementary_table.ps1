$url = "https://brdecledtyypykowjnjt.supabase.co/rest/v1/foaming_supplementary_reports"
$headers = @{
...
if ($res) {
  Write-Output "Found $($res.Count) reports in foaming_supplementary_reports."
  $res | ConvertTo-Json
} else {
  Write-Output "No reports found in foaming_supplementary_reports."
}
