$url = "https://brdecledtyypykowjnjt.supabase.co/rest/v1/foaming_pour_reports?recorder_id=eq.8acc93be-cff0-4103-b76f-4de025e9bca1&operator_name=is.null"
$headers = @{
...
if ($res) {
  Write-Output "Found $($res.Count) reports."
  $res | ConvertTo-Json
} else {
  Write-Output "No reports found."
}
